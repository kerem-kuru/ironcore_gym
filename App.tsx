...
const MembershipSection = ({ membershipPlans, setCurrentView }: MembershipSectionProps) => (
      ...
      <main className="relative z-10">
        {currentView === 'home' && (
          <div className="animate-fade-in">
            ...
            <MembershipSection membershipPlans={membershipPlans} setCurrentView={setCurrentView} />
            ...
            <ContactSection contactForm={contactForm} setContactForm={setContactForm} handleContactSubmit={handleContactSubmit} isSubmitting={isSubmitting} />
          </div>
        )}
